 ...
 */
final class Version20241117184535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT AUTO_INCREMENT NOT NULL, emetteur_passager_id INT NOT NULL, receveur_passager_id INT NOT NULL, emetteur VARCHAR(255) NOT NULL, receveur VARCHAR(255) NOT NULL, note INT NOT NULL, commentaire VARCHAR(255) NOT NULL, datefeedback DATETIME NOT NULL, INDEX IDX_D2294458D936848E (emetteur_passager_id), INDEX IDX_D2294458C83E5F65 (receveur_passager_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
